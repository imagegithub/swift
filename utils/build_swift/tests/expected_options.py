...
EXPECTED_OPTIONS = [
    ...
    DisableOption('--skip-build-fuchsia', dest='build_fuchsia'),
    ...
    DisableOption('--skip-test-fuchsia-host', dest='test_fuchsia_host'),
    ...
    PathOption('--fuchsia-x86_64-sysroot'),
    PathOption('--fuchsia-x86_64-libs'),
    PathOption('--fuchsia-aarch64-sysroot'),
    PathOption('--fuchsia-aarch64-libs'),
    PathOption('--fuchsia-icu-uc-include'),
    PathOption('--fuchsia-icu-i18n-include'),
    PathOption('--fuchsia-toolchain-path'),
